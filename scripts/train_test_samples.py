"""
Training Script for Test Samples

Train on small test samples to verify pipeline before full RAVDESS training.
Uses Primary Loss: CrossEntropy with Label Smoothing.
"""
...
class Trainer:
    ...
    def train(self):
        """Main training loop."""
        print("\n" + "="*70)
        print("TRAINING ON TEST SAMPLES")
        print("="*70)
        ...
        for epoch in range(self.num_epochs):
            ...
            if val_metrics["uar"] > self.best_uar:
                ...
                print(f"  [OK] Best model saved (UAR: {self.best_uar:.4f})")
...
def main():
    ...
    if cuda_available:
        ...
        print("  To use GPU, install: pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118")
    ...
    print("\n" + "="*70)
    print("MULTIMODAL FER - TEST SAMPLES TRAINING")
    print("="*70)
    ...
    # Create model
    print("\n[1/4] Creating model...")
    print("  Initializing MultimodalFER...")
    model = MultimodalFER(
        num_classes=8,
        num_segments=8,
    )
    ...
    # For test samples, use same data for train and val (just for testing pipeline)
